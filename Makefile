...
CXXFLAGS=--std=c++17 -g -Wall -Wextra -Wfloat-equal -Wundef -Wcast-align -Wwrite-strings -Wlogical-op -Wredundant-decls -Wshadow -Woverloaded-virtual -fopenmp -DENV_LAPTOP -DCOARSE_RESOLUTION #-Wmissing-declarations 
...
SOURCES = $(subst r_engine.cpp,,$(wildcard *.cpp))
